	...
	public void createTables() {
		...
		// Create tables: begin
					...
					try {
						...
						String sql2 = "CREATE TABLE dissability " + 
					...
					try {
						...
						String sql3 = "CREATE TABLE emmployee_contract" + 
								"(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT," + 
								"free_days INTEGER NOT NULL," + 
								"starting_date  DATE NOT NULL," + 
								"finishing_date DATE NOT NULL," + 
								"salary REAL NOT NULL," + 
								"week_hours REAL NOT NULL)";
					...
					try {
						...
						String sql4 = "CREATE TABLE pacient" + 
								"(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT," + 
								"name TEXT NOT NULL," + 
								"sex TEXT NOT NULL," + 
								"dob TEXT NOT NULL," + 
					...
					try {
						...
						String sql6 = "CREATE TABLE medical_professional" + 
								"(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT," + 
								"name TEXT NOT NULL," + 
								"dob TEXT NOT NULL," + 
					...
					try {
						...
						String sql7 = "CREATE TABLE staff" + 
					...
					try {
						...
						String sql9 = "CREATE TABLE treatment_pacient " + 
