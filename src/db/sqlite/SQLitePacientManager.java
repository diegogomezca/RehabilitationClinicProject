...
public class SQLitePacientManager implements PacientManager {
	...
	public List<Patient> searchByName(String name) {
		...
		try {
			...
			while (rs.next()) {
				...
				Patient newPacient = new Patient(id, pacientName,dob, intern, nie,active, email,phone,adress,sex);
	...
	public Patient searchById (Integer id) {
		...
		try {
			...
			newPacient = new Patient(pacient_id, pacientName,dob, intern, nie,active, email,phone,adress,sex);
