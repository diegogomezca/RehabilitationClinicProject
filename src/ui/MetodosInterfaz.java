...
public class MetodosInterfaz {
	...
	public  Pacient searchPatientById () throws Exception {
	...
	public void showaPatient (Pacient patient) {
	...
	public void addPatient () throws Exception {
		...
		Pacient newPatient = new Pacient(patientName,true,patientNie,false,patientCorreo,9876543,"lacasa","male");
